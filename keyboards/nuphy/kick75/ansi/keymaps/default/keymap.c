...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (keycode == BOOT_HOLD) {
        if (record->event.pressed) {
            ...
            if (timer_elapsed(boot_hold_timer) > 2000) {
                reset_keyboard();
            }
        }
        return false;
...
[1] = LAYOUT(
	...
	RF_DFU, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,   	_______,   	_______,   	_______,   	_______,   	_______,  	_______,   	_______,	_______, 	_______,	KC_END,
